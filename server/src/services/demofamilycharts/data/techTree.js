const { PageFitMode, AdviserPlacementType } = require('basicprimitives');
...
module.exports = {
  ...
  items: [
    ...
    { id: 3, parents: [1], title: "Engineering 101", itemTitleColor: "green", relativeItem: 2, placementType: AdviserPlacementType.Right, position: 1 },
    { id: 4, parents: [1], title: "Subsonic Flight", itemTitleColor: "blue", relativeItem: 3, placementType: AdviserPlacementType.Right, position: 1 },
    { id: 5, parents: [1], title: "Airships", itemTitleColor: "blue", relativeItem: 4, placementType: AdviserPlacementType.Right, position: 1 },
    { id: 6, parents: [1], title: "Physics and Chemistry", itemTitleColor: "green", relativeItem: 5, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 13, parents: [6], title: "Advanced Physics and Chemistry", itemTitleColor: "green", relativeItem: 12, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 17, parents: [8], title: "Specialized Launch Bases", itemTitleColor: "green", relativeItem: 16, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 25, parents: [14], title: "Propulsion Systems", itemTitleColor: "green", relativeItem: 24, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 31, parents: [19], title: "Retractable Landing Gear", itemTitleColor: "blue", relativeItem: 30, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 37, parents: [23], title: "Solid-State Electronics", itemTitleColor: "green", relativeItem: 36, placementType: AdviserPlacementType.Right, position: 1 },
    { id: 38, parents: [23], title: "Storage technology", itemTitleColor: "gray", relativeItem: 37, placementType: AdviserPlacementType.Right, position: 1 },

    { id: 39, parents: [24], title: "Nuclear Power", itemTitleColor: "brown" },
    { id: 40, parents: [24], title: "Heavier Rocketry", itemTitleColor: "green", primaryParent: 24, relativeItem: 39, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 45, parents: [27], title: "Actuators", itemTitleColor: "green", relativeItem: 43, placementType: AdviserPlacementType.Right, position: 1 },
    { id: 46, parents: [30], title: "Supersonic Flight", itemTitleColor: "green" },
    { id: 47, parents: [30], title: "Advanced Aerodynamics", itemTitleColor: "green", primaryParent: 30, relativeItem: 46, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 55, parents: [37], title: "Heat Management Systems", itemTitleColor: "orange", relativeItem: 54, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 61, parents: [43], title: "Composites", itemTitleColor: "green", relativeItem: 60, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 75, parents: [171], title: "Nuclear Fuel Systems", itemTitleColor: "brown", relativeItem: 74, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 115, parents: [93], title: "Cutting-Edge Solar Technology", itemTitleColor: "navy", relativeItem: 114, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 132, parents: [110], title: "Advanced Electrostatic Thrusters", itemTitleColor: "#533153", relativeItem: 131, placementType: AdviserPlacementType.Right, position: 1 },
    ...
    { id: 166, parents: [38], templateName: "dot", itemTitleColor: "gray", relativeItem: 56, placementType: AdviserPlacementType.Right, position: 1 },
