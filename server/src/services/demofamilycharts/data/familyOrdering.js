const { PageFitMode, AnnotationType, ConnectorShapeType, ConnectorPlacementType,
  Colors, ConnectorLabelPlacementType, LineType, ZOrderType, Thickness, AdviserPlacementType
 } = require('basicprimitives');
