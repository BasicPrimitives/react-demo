...
## Basic Primitives Diagrams PDFKit plugin
* 100% JavaScript in-browser or NodeJS PDF rendering based [PDFkit](http://pdfkit.org/) (MIT) library.
...
* JSX templates
* 100 Virtual DOM rendering cycle, i.e. no direct DOM rendering
